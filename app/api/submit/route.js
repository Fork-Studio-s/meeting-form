...
function buildConfirmationEmailHtml(data) {
  ...
  const bodyText = isId
    ? `Kita sudah terima data terkait <strong style="color:#201e1b;">${businessName}</strong>. Tim Gabeln Studio sedang meninjau detail intake kamu dan akan segera menghubungi untuk menjadwalkan sesi konsultasi.`
  ...
  return `
    ...
    <html>
      ...
      <body style="margin:0;padding:0;background-color:#15161b;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#15161b;padding:40px 16px;">
          <tr>
            <td align="center">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:520px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 8px 30px rgba(0,0,0,0.3);">
                <!-- Card Content -->
                <tr>
                  <td style="padding:40px 36px;">
                    <p style="margin:0 0 12px;font-size:11px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:#d9a441;">Gabeln Studio &bull; Intake Received</p>
                    <h1 style="margin:0 0 18px;font-size:24px;font-weight:500;color:#201e1b;line-height:1.3;">${headline}</h1>
                    <p style="margin:0 0 24px;font-size:15px;line-height:1.65;color:#6e685f;">
                      ${bodyText}
                    </p>

                    <!-- Summary Card -->
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#f9f8f6;border:1px solid #e8e4de;border-radius:8px;margin-bottom:26px;">
                      <tr>
                        <td style="padding:18px 22px;">
                          <div style="font-size:11px;color:#8e8b82;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:4px;">${labelExploring}</div>
                          <div style="font-size:14px;font-weight:600;color:#201e1b;margin-bottom:14px;">${service}</div>
                          <div style="font-size:11px;color:#8e8b82;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:4px;">${labelOutcome}</div>
                          <div style="font-size:14px;font-weight:600;color:#201e1b;">${outcome}</div>
                        </td>
                      </tr>
                    </table>

                    <p style="margin:0 0 28px;font-size:14px;line-height:1.6;color:#6e685f;">
                      ${replyNote}
                    </p>

                    <div style="border-top:1px solid #eee;padding-top:20px;">
                      <p style="margin:0 0 6px;font-size:15px;color:#201e1b;font-weight:600;font-style:italic;font-family:Georgia,serif;">Gabeln Studio</p>
                      <p style="margin:0 0 6px;font-size:12px;color:#8e8b82;line-height:1.5;">International Digital-First Web Design Studio based in Bandung, Indonesia.</p>
                      <p style="margin:0 0 4px;font-size:12px;"><a href="https://gabelnstudio.com" style="color:#d9a441;text-decoration:none;font-weight:500;">gabelnstudio.com</a></p>
                      <p style="margin:0;font-size:12px;color:#8e8b82;">+62 895-3091-0379</p>
                    </div>
                  </td>
                </tr>
              </table>
